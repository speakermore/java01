...
public class Newly implements Serializable {
	...
	public Newly(String companyId, String userId, String companyRecruitTitle, String artileTitle,
	...
	public String toString() {
		return "Newly [companyId=" + companyId + ", userId=" + userId + ", companyRecruitTitle=" + companyRecruitTitle
