...
import ynjh.admin.entity.Validate;
...
public class AdminController {
	...
	public ModelAndView findLogin(String adminLoginId, String adminPassword, String validateCode,HttpServletRequest request,HttpSession session) {
		ModelAndView mv = new ModelAndView();
		Validate validate =  (Validate) session.getAttribute("codeValidate");
		String value=null;
		if(validate!=null){
	 ...
	 */
		 ...
		 * 登录的管理员，自我信息修改
		 * @author 
		 * @param adminName 管理员实际姓名
		 * @param adminTel 管理员电话
		 * @param adminEmail 管理员电子邮件
		 * @param session
		 * @return
		 */
