...
public class AdminController {
	...
	public ModelAndView findAdminLogByTime() {
		// List<AdminLog> adminLogs = adminService.findAdminLogByTime(beginTime,
		// endTime,page);
		ModelAndView mv = new ModelAndView("admin/findAdminLogByTime");
		// String beginTime, String endTime,Integer
		// pagemv.addObject("adminLogs", adminLogs);
		return mv;
	}
	...
	public ModelAndView findAdminLogByTimeAndId() {
		...
		// adminService.findAdminLogByTimeAndId(userLoginId, beginTime,
		// endTime,page);
	...
	public ModelAndView findAdminLogByIdAndDo() {
		// List<AdminLog> adminLogs =
		// adminService.findAdminLogByIdAndDo(userLoginId, adminDo,page);
	...
	public ModelAndView findAdminLogByTimeAndDo() {
		// List<AdminLog> adminLogs =
		// adminService.findAdminLogByTimeAndDo(beginTime, endTime,
		// adminDo,page);
	...
	public ModelAndView findAdminLogByTimeAndDoAndId() {
		// List<AdminLog> adminLogs =
		// adminService.findAdminLogByTimeAndDoAndId(adminDo, userLoginId,
