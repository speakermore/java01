...
public interface AdminMapper {
	...
	public Integer auditCommentsArticle(@Param("CAId")Integer CAId,@Param("commentsArticleStatus")Integer commentsArticleStatus);//审核文章评论
	public List<CommentArticle> findAuditCommentsArticle(Integer page);//查询审核文章评论
	public Integer auditCompany(@Param("companyId")Integer companyId,@Param("cmpIntegerStatus")Integer cmpIntegerStatus);//审核企业资质
	public List<Company> findAuditCompany(Integer page);//查询审核企业资质
	public Integer auditCommentsCompanyAndPeople(@Param("CCPId")Integer CCPId,@Param("discussStatus")Integer discussStatus);//审核个人企业互评论
	...
	public Integer auditRecruitment(@Param("recruitmentId")Integer recruitmentId,@Param("cmpRecStatus")Integer cmpRecStatus);//审核招聘信息
	public List<CompanyRecruit> findAuditRecruitment(Integer page);//查询审核招聘信息
	
	//信息维护--修改正在登录的管理员信息
	public Integer maIntegerainAdmin(@Param("adminName")String adminName,@Param("adminTel")String adminTel,@Param("adminEmail")String adminEmail);//改
