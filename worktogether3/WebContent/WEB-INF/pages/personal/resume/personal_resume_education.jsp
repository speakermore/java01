...
<c:if test="${edus!=null }">
	<c:forEach items="${edus }" var="edu">
		<div class="panel-body test personal_resume_defualt">
			<c:if test="${user.id>=1234567890 }"><small class="col-sm-offset-10">(${AUDIT_STATUS[edu.resumeType]})</small></c:if>
			<div class="col-sm-12">
			...
			<div class="col-sm-12">
				...
				<fmt:formatDate value="${edu.educationBeginTime}" pattern="yyyy-MM" />
				到
						...
						<div class="modal-content">
							...
							<div class="modal-footer">
								<form id="updateEducationForm${edu.id}"
									...
									<div class="col-sm-12 column margin_bottom_AND_margin_top">
										<label class="col-sm-3 control-label">教育描述：</label>
										<div class="col-sm-8 column">
											<input class="form-control" type="text"
									...
									<div class="col-sm-12 column margin_bottom_AND_margin_top">
										<label class="col-sm-3 control-label">教育时间：</label>
