...
<c:if test="${works!=null}">
	...
	<c:forEach items="${works}" var="work">
		<div class="panel-body test personal_resume_defualt">
			<c:if test="${user.id>=1234567890 }"><small class="col-sm-offset-10">(${AUDIT_STATUS[work.resumeType]})</small></c:if>
			<div class="col-sm-12">
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-footer">
								<form id="updateWorkForm${work.id}" class="form-horizontal col-sm-12 ">
