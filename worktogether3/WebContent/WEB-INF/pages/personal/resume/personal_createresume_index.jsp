...
<article class="panel panel-default">
	...
	var ajaxUploadHeadImg=function(){
		...
		<div class="panel-heading">
			<div class="panel-title">资料填写</div>
		</div>
		...
		<form role="form" class="form-horizontal" action="personal/resume/createResume" method="post" id="resumeForm" style="margin-top: 35px;">
			...
			<section class="panel panel-success">
				<div class="panel-heading">
					<h5 class="panel-title">第一步：候选职位</h5>
				</div>
				<div class="panel-body">
				<div class="form-group">
					...
					<input id="resumeTitle" type="hidden" name="resumeTitle" value="null" />
					<script type="text/javascript">
			...
			<div id="selected-job" class="form-group">
				<label class="col-sm-3 alert alert-success">亲，可以选择三个候选职位哦：</label>
			</div>
			</div>
		</section>
		 <!-- 基本信息 -->
		<section class="panel panel-success">
			<div class="panel-heading">
				<h5 class="panel-title">第二步：基本资料</h5>
			</div>
			<div class="panel-body">
		<!-- 牟勇：已增加文件上传功能 -->
		<div class="col-sm-2">
		...
		<div class="col-sm-5">
			<div class="form-group">
				...
				<div class="col-sm-7">
					<div class="col-sm-1">
						<input type="radio" name="resumeGender" id="resumeGender" value="1" checked="checked">
					</div>
					<label class="col-sm-4">男</label>
					<div class="col-sm-1">
						<input type="radio" name="resumeGender" id="resumeGender" value="0"> 
					</div>
					<label  class="col-sm-4">女</label>
				</div>
			</div>
			<div class="form-group">
		...
		<div class="panel-group panel-success">
			<div class="panel-heading">
				<h5 class="panel-title">第三步：更多详细资料</h5>
				<a class="col-sm-offset-10" data-toggle="collapse" data-parent="#panel" href="#panel-element-more">展开更多 <span class="glyphicon glyphicon-chevron-down"></span></a>
			</div>
