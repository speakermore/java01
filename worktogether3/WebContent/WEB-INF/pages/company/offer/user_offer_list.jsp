			...
			<div class="col-sm-12 col-sm-offset-0">
				...
				<table class="table table-hover">
					...
					<tbody>
						...
						<tr>
							<!-- 点击查看详细信息 -->
							<td><a href="offer/user_offer_detail/${o.id }">${o.companySimpleName }</a></td>
							<td>${o.offerJob }</td>
				...
				<hr/>				
				<ul class="pager">				
					<li><a href="offer/user_offer_list/1">首页</a></li>
					
					<c:if test="${page>1 }">
						<li><a href="offer/user_offer_list/${page-1 }">&laquo;</a></li>
					</c:if>
						
					<c:if test="${maxPage<=5 }">
						<c:forEach begin="${1 }" end="${maxPage }" var="i">
						<li><a href="offer/user_offer_list/${i }">${i }</a></li>
						</c:forEach>
					</c:if>
					...
					<c:if test="${page<maxPage }">
						<li><a href="offer/user_offer_list/${page+1 }">&raquo;</a></li>
					</c:if>
					
					<li><a href="offer/user_offer_list/${maxPage }">尾页</a><li>
...
function jump(){
    ...
    if(page<1 || page>max){
    	...
    	location.href="offer/user_offer_list/"+page;
    }
}	
</script>
