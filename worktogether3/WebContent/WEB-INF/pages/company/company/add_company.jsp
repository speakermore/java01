...
<%@include file="/WEB-INF/pages/nav.jsp" %>
	<div class="container">
		...
		<div class="col-sm-6">
		<form class="form-horizontal" role="form" action="company/company/addCompany" method="post" id="addCompany">
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<input type="password" class="form-control" id="exampleInputPassword1" name="companyPassword"/>
			</div>	
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<input type="password" class="form-control" id="exampleInputPassword1" name="realCompanyPassword"/>
			</div>	
		</div>
			...
			<div class="col-sm-3">
				<button type="submit" class="form-control btn btn-success" style="color: black;">注册</button>
			</div>
