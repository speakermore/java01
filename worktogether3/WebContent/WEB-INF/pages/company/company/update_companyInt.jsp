			...
			<div class="col-sm-6 column">
				...
				<form action="company/company/updateInt" method="post"
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" name="cmpIntComforts"
								value=${companyInt.cmpIntComforts } />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" name="cmpIntRest"
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" name="cmpIntInsurance"
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" name="cmpIntWage"
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control"
								value=${user.companyAddress } name="companyAddress" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" name="cmpIntroduction"
