...
CREATE TABLE `commentarticle` (
  ...
  `commentArticleUsersType` int(11) DEFAULT NULL COMMENT '1.企业 2.用户',
  PRIMARY KEY (`id`)
...
INSERT INTO `discuss` VALUES (1,123456789,'内容',1,'2017-04-07 11:22:10',1,2);
...
-- Dump completed on 2017-04-08 16:21:28
